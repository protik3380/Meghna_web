...
namespace EFreshStore.Utility
{
    public class SSLCommerz
    {
        ...
        public PaymentDetail OrderValidate(string MerchantTrxID, string MerchantTrxAmount, string MerchantTrxCurrency, HttpRequest req)
        {
            PaymentDetail resp = null;
            ...
            if (hash_verified)
            {
                ...
                if (json != "")
                {
                     resp = new JavaScriptSerializer().Deserialize<PaymentDetail>(json);
        ...
        protected void SetSSLCzTestMode(bool mode)
        {
            ...
            if (mode)
            {
                this.Store_ID = "nerdc5e8eede5660f8";
                this.Store_Pass = "nerdc5e8eede5660f8@ssl";
                //this.Store_ID = "nerdc5e82f0d18a1fc";
                //this.Store_Pass = "nerdc5e82f0d18a1fc@ssl";
